...
class Table_Coding(QtWidgets.QFrame):
    def __init__(self, parent=None):
        QtWidgets.QFrame.__init__(self,parent)
        layout = QtWidgets.QHBoxLayout()
        self.table = QtWidgets.QComboBox()
        self.table.addItems(["utf_8","ascii","big5","big5hkscs","cp037","cp273","cp424","cp437","cp500","cp720",
...
"iso8859_13","iso8859_14","iso8859_15","iso8859_16","johab","koi8_r","koi8_t",
"koi8_u","kz1048","mac_cyrillic","mac_greek","mac_iceland","mac_latin2",
